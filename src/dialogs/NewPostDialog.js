...
import { serverHost, PRIVACY_PUBLIC, PRIVACY_SPECIFIC_FRIENDS, PRIVACY_PRIVATE } from "../constants";
...
const NewPostDialog = ({ open, closeDialogHandler, groupTitle, groupId, submitHandler }) => {
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', mt: 1 }}>
                                ...
                                <Icon user={user} />
                                {
                                    !groupTitle ?
                                        ...
                                        :
                                        <Stack sx={{ ml: 2 }}>
                                            <Typography variant='subtitle1'>{nick} / {groupTitle}</Typography>
                                            {
                                                groupTitle &&
